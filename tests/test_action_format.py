...
class TestFormatAction:
    ...
    def test_numeric_values(self, action):
        ...
        arguments = FormatArguments(
            template="Count: {count}, Price: {price:.2f}",
            data={"count": 5, "price": 19.99}
        )
        result = action.run(arguments)
    ...
    def test_special_characters_in_template(self, action):
        ...
        arguments = FormatArguments(
            ...
            data={"email": "test@example.com", "symbol": "$"}
        )
        result = action.run(arguments)
    ...
    def test_format_specification(self, action):
        ...
        arguments = FormatArguments(
            template="Hex: {num:x}, Binary: {num:b}, Percentage: {ratio:.1%}",
            data={"num": 255, "ratio": 0.75}
        )
        result = action.run(arguments)
    ...
    def test_extra_data_variables(self, action):
        ...
        arguments = FormatArguments(
            template="Hello {name}!",
            data={"name": "World", "extra": "unused", "another": 123}
        )
        result = action.run(arguments)
    ...
    def test_escape_braces(self, action):
        ...
        arguments = FormatArguments(
            template="Literal braces: {{not_a_variable}} but this is: {var}",
            data={"var": "value"}
        )
        result = action.run(arguments)
